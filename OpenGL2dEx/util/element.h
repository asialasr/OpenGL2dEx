...
public:
	...
	void render(const Optional<SpriteRenderer*> sprite_renderer)
	{
		render_impl(sprite_renderer);
	}
...
private:
	...
	virtual void render_impl(Optional<SpriteRenderer*> sprite_renderer) = 0;
